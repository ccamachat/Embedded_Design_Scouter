...
// Pause/Play the song
// Inputs:  none
// Outputs: 0 if the song is paused, 1 if its playing

uint32_t Play_Button_Handler(void);

// Rewind
// Inputs:  none
// Outputs: 0 if the song unsuccessfully rewinded, 1 if successfully rewinded
uint32_t Rewind_Button_Handler(void);